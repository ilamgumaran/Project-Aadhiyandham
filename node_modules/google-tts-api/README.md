...
### 4.2. `getAudioBase64(text, [option])`
...
### 4.3. `getAllAudioUrls(text, [option])` (For text longer than 200 characters)
...
### 4.4. `getAllAudioBase64(text, [option])` (For text longer than 200 characters)
