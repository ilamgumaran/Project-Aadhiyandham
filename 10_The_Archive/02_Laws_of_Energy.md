# The Laws of Energy: Efficiency Audit Guide

## 1. Why This Is Important
Energy is the primary currency of existence. Every time we transform energy (e.g., from water flow to mechanical rotation to heat), we "pay a tax" in the form of waste heat (2nd Law of Thermodynamics). In Aadhiyandham, we eliminate waste by minimizing conversions. This module ensures the settlement uses its limited energy budget with maximum logic.

## 2. Expected Outcome
Machines and systems that achieve the highest possible work-output per unit of fuel or kinetic input, extending the life of components and reducing settler labor.
...
INPUT (100%) ----> [ CONVERSION 1 ] ----> [ CONVERSION 2 ] ----> WORK (70%)
                        |                      |
                        V                      V
...
## 5. Maintenance Guide
*   **Alignment:** Use a plumb line and level to ensure all shafts are perfectly straight. 
