...
## 2. Expected Outcome
A settlement where occupants maintain high serotonin naturally, and where buildings require minimal fuel for heating.
...
4.  **Second Mark:** In the afternoon, wait until the shadow tip touches the circle again. Mark this with a second stone.
5.  **The Axis:** Draw a line between the two stones. The line perpendicular to this, crossing through the stick, points exactly to **True North and South**.
