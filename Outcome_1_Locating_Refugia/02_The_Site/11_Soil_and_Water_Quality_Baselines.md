# Soil and Water Quality Baselines: What the Earth Can Give and What It Cannot
...
outcome:        1
difficulty:     moderate
time_to_build:  2-4 weeks (initial survey + first growing season)
season:         spring (for soil tests), year-round (for water)
team_size:      2
depends_on:
  - 06_Field_Mineralogy_and_Zero_Tech_Analysis.md
  - 05_Hydrological_Analysis_and_Watershed_Math.md
provides_to:
  - 02_Terra_Preta_and_Biochar.md
  - 03_Heirloom_Seed_Banking.md
  - 02_Bio_Sand_Filtration.md
  - 09_Geological_Stability_Assessment.md
materials:
  - vinegar (acidity test)
  - baking soda (if available, alkalinity test)
  - glass jar or clear vessel
  - clean cloth
  - boiling water
status:         complete
-->
...
| Nutrient | Symbol | What It Does | Deficiency Symptom (in plants) | Depletion Timeline |
|:---|:---|:---|:---|:---|
| **Nitrogen** | N | Leaf and stem growth | Yellow leaves starting from the bottom of the plant | 1-3 years without replenishment |
...
**Nitrogen Test (The Weed Indicator Method):**

| Observation | N Level | Action |
|:---|:---|:---|
| Nettles, chickweed, fat hen grow vigorously on the site | High N | Excellent starting fertility |
| Legumes (clover, vetch) dominate | Low-Moderate N | Legumes fix their own N because the soil is deficient |
| Sparse, pale-green vegetation; mossy ground | Very Low N | Will require heavy composting + legume cover-cropping for 2+ years before staple crops |

**Phosphorus Test (The Root Observation):**

1.  Dig up a wild plant growing on the site. Examine the roots.
2.  If the roots are heavily colonized by **mycorrhizal fungi** (white, web-like threads coating the roots): phosphorus is LOW. The plant is relying on fungal partners to scavenge scarce P.
3.  If roots are clean and white with minimal fungal colonization: phosphorus is ADEQUATE. The plant can absorb P directly from soil solution.

**Potassium Test (The Burn Test):**

1.  Collect a handful of wild grass or weeds from the site. Dry them completely.
2.  Burn the dry plant material in a small fire until only ash remains.
3.  Dissolve a teaspoon of the ash in a cup of water. Let it settle for 1 hour.
...
|:---|:---|:---|
| Shallow-rooted (lettuce, beans, herbs) | 15 cm (6 inches) | Can grow in raised beds over rock |
| Medium (potatoes, squash, grains) | 30 cm (12 inches) | Most staple crops |
| Deep-rooted (taro, cassava, fruit trees) | 60+ cm (24+ inches) | Essential for long-term caloric base |
...
|:---|:---|:---|
| **Metallic sheen on puddle surfaces** | Heavy metal contamination (often lead, copper, or iron in toxic concentrations) | Do NOT grow food in this soil. Use as building material only. Import soil for raised beds. |
| **Patches where nothing grows** (bare soil surrounded by normal vegetation) | Toxic contamination or extreme pH (salinity, acid, or heavy metal) | Avoid entirely. Test with vinegar: if it fizzes vigorously on the bare patch but not on adjacent soil, the patch may be alkaline waste (concrete, lime, industrial slag). |
...
| Nutrient | Annual Removal by Crops (approx.) | Natural Replenishment | Estimated Depletion Without Intervention |
|:---|:---|:---|:---|
| **Nitrogen** | 100-150 kg/hectare/year | Legume cover crops fix 50-200 kg/ha/year; compost returns 20-50 kg/ha/year | Sustainable with legume rotation + composting |
| **Phosphorus** | 15-25 kg/hectare/year | Almost zero natural input (no geological source in most soils) | **5-15 years** without external P source |
| **Potassium** | 50-100 kg/hectare/year | Slow mineral weathering replaces 10-30 kg/ha/year | 5-10 years; manageable with wood ash return |

**The phosphorus problem is the most critical long-term fertility issue.** Without synthetic fertilizer, the only P sources are:
*   **Bone meal:** Ground animal bones (livestock, fish). Returns ~15% phosphorus by weight.
*   **Human waste composting (humanure):** Returns the P consumed in food back to the soil. **This is why the humanure module (Section 03) is a non-negotiable part of the system.**
...
|:---|:---|:---|:---|
| **Clarity** | Can see through 30cm depth | Fill a clear vessel; place your hand behind it | Turbidity indicates suspended pathogens or sediment |
| **Color** | Clear to very pale yellow | Compare to clean rainwater in identical vessel | Brown/orange = dissolved organic matter or iron. Green = algae. |
| **Odor** | No detectable smell | Sniff at water surface | Sulfur (rotten eggs) = anaerobic bacteria. Musty = algae. Chemical = contamination. |
...
**Test for Alkalinity (high pH):**
1.  Collect a water sample.
2.  Add a splash of vinegar.
3.  If it fizzes: the water is alkaline (pH > 7.5). The stronger the fizz, the higher the pH.

**Test for Acidity (low pH):**
1.  Add a pinch of baking soda (or a teaspoon of fresh wood ash) to the water sample.
2.  If it fizzes: the water is acidic (pH < 6.5).
...
| Organism | What It Indicates | Water Quality |
|:---|:---|:---|
| **Mayfly nymphs, stonefly nymphs** (found under rocks in flowing water) | High dissolved oxygen, low pollution | EXCELLENT — safe to drink after basic filtration |
| **Caddisfly larvae** (in small tube-shaped cases of sand/sticks) | Good oxygen, moderate organic matter | GOOD — safe after slow sand filtration |
| **Chironomid larvae** (small red "bloodworms" in mud) | Low oxygen, high organic pollution | POOR — requires full bio-sand filtration + boiling |
...
*   **After heavy rain:** Turbidity spikes (runoff carries soil, pathogens, and animal waste into waterways). Allow 24-48 hours for settling before collecting drinking water from streams.
...
1.  Record clarity (can/cannot see hand at 30cm).
2.  Record color (clear, yellow, brown, green).
3.  Record odor (none, earthy, sulfur, chemical).
4.  Record taste after boiling (neutral, metallic, salty, bitter).
5.  Record pH result (acid fizz, alkaline fizz, neither).
6.  Record biological indicators (which organisms present under rocks).
...
|:---|:---|:---|:---|:---|
| **Soil depth** | >60cm | 30-60cm | 15-30cm | <15cm over rock |
| **N indicators** | Nettles + fat hen present | Mixed vegetation | Legume-dominated | Bare/mossy ground |
| **P indicators** | Clean roots, no mycorrhizal dependence | Light fungal colonization | Heavy mycorrhizal dependence | No growth at all |
| **K indicators** | Soapy ash water | Mildly slippery | Neutral ash water | N/A |
| **Water clarity** | Clear year-round | Turbid only after rain | Turbid most of the time | Permanently opaque |
| **Water biology** | Mayfly/stonefly nymphs | Caddisfly larvae | Chironomid only | No aquatic life |
| **Water pH** | No fizz (neutral) | Mild acid or alkaline fizz | Strong fizz | Extreme (corrodes metal) |
| **Contamination** | No red flags | 1 minor flag | Multiple flags | Metallic sheen or dead zones |

**Scoring:**
*   **18-24:** Prime site. Proceed with full development.
*   **12-17:** Viable with investment. Identify which parameters need remediation (composting, filtration, raised beds) and estimate the labor cost.
