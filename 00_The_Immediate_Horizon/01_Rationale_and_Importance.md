...
The "Immediate Horizon" is the most volatile phase of Project Aadhiyandham. Upon arrival at a candidate location, the settlers transition from a state of scavenging or transit to a state of permanent habitation. This module exists to bridge that gap.
...
**Rationale:** Understanding the universal emergency calories of a mountain-protected environment ensures that even if initial supplies are lost, the group has a "buffer" of time to establish their first agricultural cycle.
