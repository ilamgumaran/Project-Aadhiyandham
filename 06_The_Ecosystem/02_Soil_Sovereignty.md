...
## 2. Expected Outcome
A deep, black, nutrient-rich topsoil capable of supporting high-intensity agriculture for centuries with zero synthetic inputs.
...
4.  **Outcome:** Fine, aerated soil that integrates perfectly with biochar.

---

## 4. How-To: Producing Raw Biochar (The Cone-Pit Method)
1.  **Pit:** Dig a 1m deep cone-shaped hole.
2.  **Burn:** Build a fire at the bottom; layer biomass on top to consume oxygen.
3.  **Quench:** Soak with water once the pit is full of glowing coals.

---

## 5. How-To: The Activation Protocol (Charging)
**CRITICAL:** Mix **1 bucket of Biochar** with **1 bucket of active Compost/Manure**. Age for **4 weeks** while moist.
