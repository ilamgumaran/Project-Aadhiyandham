...
## 2. Expected Outcome
The ability to move 100-200kg of supplies using a single animal (or human pair) without needing a road or a wagon.
...
4.  **Usage:** The narrow end is carried by the animal; the wide end drags on the ground.
5.  **Benefit:** Unlike a wagon, a travois cannot "break an axle" and can move over mud, rocks, and through dense forest with ease.

---

## 4. How-To: The Port-to-Foothill Transition
1.  **Secure Mover:** Acquire Mule or Ox.
2.  **Navigation:** Follow river upstream to the 100m contour.
