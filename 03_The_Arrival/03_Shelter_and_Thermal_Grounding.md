...
## 2. Expected Outcome
A habitable structure that maintains a stable internal temperature (approx. 18°C–22°C) regardless of external weather spikes, requiring zero external energy input for maintenance.
...
| **Flexible Rods** | The "Wattle" (Lath) | Thin, green willow or hazel saplings that can be woven. |
| **Sub-Soil (Clay)** | The Binder | Dig 30-50cm below the topsoil until you reach sticky clay. |
