...
<head>
    <meta charset="UTF-8">
    <title>03 Shelter and Thermal Grounding - Module 03 - Project Aadhiyandham</title>
...
<body>
    ...
    <div class="breadcrumbs"><a href="../../index.html">Index</a> &gt; <a href="../01_Rationale_and_Importance.html">03 The Arrival</a> &gt; <span>Shelter and Thermal Grounding</span></div>

    <section>
        <h2>1. Why This Is Important (The Rationale)</h2>
        <p>Exposure to wind, rain, and fluctuating temperatures is a primary cause of physical and psychological fatigue. Modern construction relies on constant electrical heating and cooling. In Aadhiyandham, we must utilize topography and raw natural materials to create a self-regulating internal environment that protects the settlers' biological energy without requiring a single watt of electricity.</p>

        <hr>

        <h2>2. Micro-Site Selection: The Perfect Spot</h2>
        ...
        <div class="diagram-container">
            ...
            <svg width="600" height="350" viewBox="0 0 600 350" xmlns="http://www.w3.org/2000/svg">
                ...
                <path d="M 130 100 L 250 180" stroke="#fbc02d" stroke-width="3" stroke-dasharray="6,4" marker-end="url(#arrow-yellow)"/>
                <text x="140" y="70" font-size="14" font-weight="bold" fill="#f57f17">Low Winter Sun</text>
                
                <!-- Mountain/Slope -->
                <path d="M 0 100 L 200 250 L 400 320 L 600 320 L 600 350 L 0 350 Z" fill="#8d6e63"/>
                <path d="M 0 120 L 200 270 L 400 350 L 0 350 Z" fill="#795548"/>
                
                <!-- River -->
                <path d="M 400 320 Q 500 340 600 320 L 600 350 L 400 350 Z" fill="#2196F3"/>
                <text x="500" y="340" font-size="14" font-weight="bold" fill="#fff">River Basin</text>

                <!-- Cold Air Pooling -->
                <path d="M 400 300 Q 500 320 600 300 L 600 320 L 400 320 Z" fill="#b3e5fc" opacity="0.6"/>
                <text x="480" y="300" font-size="12" font-weight="bold" fill="#0277bd">Cold Air Pool (Frost)</text>
                
                <!-- Flood Line -->
                <line x1="380" y1="300" x2="600" y2="300" stroke="#d32f2f" stroke-width="2" stroke-dasharray="4,2"/>
                <text x="400" y="290" font-size="12" font-weight="bold" fill="#d32f2f">100-Year Flood Line</text>

                <!-- Thermal Belt -->
                <path d="M 150 200 Q 250 220 300 280 L 150 280 Z" fill="#ffcc80" opacity="0.3"/>
                <text x="160" y="275" font-size="12" font-weight="bold" fill="#e65100">The Thermal Belt (Warm)</text>

                <!-- The Shelter -->
                <polygon points="250,220 220,250 280,250" fill="#5d4037"/>
                <rect x="230" y="250" width="40" height="30" fill="#d7ccc8"/>
                <rect x="245" y="260" width="10" height="20" fill="#3e2723"/>
                
                <line x1="280" y1="230" x2="350" y2="180" stroke="#333" stroke-width="2"/>
                <text x="355" y="175" font-size="14" font-weight="bold" fill="#212121">Optimal Shelter Site</text>

                <defs>
                    <marker id="arrow-yellow" viewBox="0 0 10 10" refX="5" refY="5" markerWidth="6" markerHeight="6" orient="auto-start-reverse">
                        <path d="M 0 0 L 10 5 L 0 10 z" fill="#fbc02d" />
                    </marker>
                </defs>
            </svg>
        </div>
        ...
        <h2>3. Gathering Generational Materials</h2>
        <p>You cannot rely on scavenged plywood. You must learn to read the forest for durable, rot-resistant materials.</p>

        <div class="how-to">
            <div class="instruction-step"><strong>1. Structural Wood (The Bones):</strong> Never use Pine for posts touching the soil; it will rot in two years. Seek out <strong>Black Locust, Cedar, White Oak, or Chestnut</strong>. These contain natural tannins resisting fungal decay. Harvest them in deep winter when sap is low.</div>
            <div class="instruction-step"><strong>2. Stone (The Foundation):</strong> Wood must never touch wet earth. Build a plinth using flat, dense stones. Perform the "Clink Test": Strike two stones together. A high-pitched "clink" means they are structurally sound; a dull "thud" means they will crumble.</div>
            <div class="instruction-step"><strong>3. Thatch and Leaves (The Roof):</strong> For a roof that lasts 20 years, harvest <strong>Phragmites (Reed grass) or Cattails</strong>. Thatch must be tied in dense bundles and layered from the bottom upward, overlapping by 80% to force rainwater to cascade off.</div>
        </div>

        <hr>

        <h2>4. Natural Pest and Insect Deterrence</h2>
        <p>A shelter full of mosquitos and ticks will quickly lead to sleep deprivation and vector-borne diseases.</p>

        <div class="how-to">
            <ul>
                <li><strong>Biological Smudging (Smoke):</strong> Insects navigate via carbon dioxide. Before sleeping, burn a small bundle of dried <strong>Mugwort, Sage, or Pine needles</strong> inside the shelter. The thick smoke paralyzes mosquito respiratory systems.</li>
                <li><strong>Botanical Repellents:</strong> Plant <strong>Lemon Balm, Catnip, Marigolds, and Wild Garlic</strong> directly around the foundation. Crush the leaves of Wild Mint or Cedar and rub the oils onto wooden window sills to break ant pheromone trails.</li>
                <li><strong>The Raised Floor:</strong> Never sleep directly on dirt. Build a raised sleeping platform at least 18 inches off the ground using lashed saplings to avoid venomous snakes and scorpions.</li>
            </ul>
        </div>
