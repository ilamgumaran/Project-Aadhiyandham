...
Protocol:
1. Conduct adult-only sessions (monthly for the first year) where founding members share their grief, anger, and loss about the collapse
2. These sessions are not therapy in the clinical sense — they are structured witnessing. Each person speaks; others listen without fixing.
3. The goal is not to "get over it" but to integrate the loss into a coherent narrative: "This happened. It was devastating. We survived. We are building something."
...
**Ages 6-9:** Introduce the Before and the Rupture in simple terms. "There used to be big cities with millions of people. Many things went wrong that the adults could not fix, and most of those cities are empty now. Our grandparents and parents came here to build a new kind of life." Answer questions honestly but briefly. Children at this age are concrete thinkers — they will ask practical questions ("What happened to the animals?" "Where are the cities?") rather than existential ones.

**Ages 10-13:** More detail about both the old world and the collapse. This is the age of moral reasoning development (Kohlberg) — children will ask "Why?" and "Was it fair?" Engage these questions seriously. Introduce complexity: the old world was not all good or all bad. The collapse was not simple. Multiple causes, multiple failures.
...
1. **Community emblem:** A visual symbol agreed upon by the community (including children old enough to contribute ideas). Rendered on the communal gathering space, on tools, on clothing. It should represent what the community values, not what it lost.

2. **Timeline wall:** A physical surface (stone, wood, plastered wall) where significant events are recorded chronologically. Each year, new events are added. Children can see the community's history literally growing.

3. **Personal heritage objects:** Founding adults who possess objects from the old world (a photograph, a tool, a book) should share these with children in structured storytelling contexts — not as relics of a lost paradise but as artifacts that connect past to present.
...
```
    ...
    PAST                    PRESENT                 FUTURE
    (The Before)            (Who We Are)            (What We Build)
    +-----------+           +-----------+           +-----------+
    | Honest    |           | Our daily |           | Our       |
    | account   |  Rupture  | life, our |  Purpose  | children's|
    | of old    |---------->| people,   |---------->| world,    |
    | world     |           | our place |           | better    |
    +-----------+           +-----------+           +-----------+
         |                       |                       |
         |   (not idealized)     |   (not diminished)    |  (not utopian)
         |                       |                       |
    "They built               "We live well           "You will carry
     extraordinary             with what we            this forward
     things and also           have and who            and make it
     broke much."              we are."                your own."

    AGE-APPROPRIATE LAYERING:
    Ages 3-5:   [.............|===PRESENT===|.............]
    Ages 6-9:   [===PAST(simple)==|===PRESENT===|=FUTURE=]
    Ages 10-13: [===PAST(complex)==|==PRESENT==|=FUTURE==]
...
**Months 6-12 (Deepen):**
9. Evaluate: Are children asking questions about the past? This is a sign of healthy curiosity, not anxiety. Engage it.
10. Are adults able to narrate without being overwhelmed? If not, continue grief sessions.
11. Develop the coming-of-age ceremony with input from older children and adolescents
12. Encourage children to contribute to community symbols (art, carvings, songs)

**Year 2 and beyond:**
13. The rituals and narratives should begin to feel natural rather than forced
...
- Adolescents who transition to adulthood with a coherent identity and a sense of their own agency in shaping the community's future
